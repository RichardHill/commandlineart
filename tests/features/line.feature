...
#     Scenario: Creating a Line that is not in the canvas
#         Given I run the app 
#         When I process the Line command 'l' and parameters 1 1 40 40
#         Then I see the line canvas specific error message 'The line you have defined does not fit within the canvas'
